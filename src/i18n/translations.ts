...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  'joblens.step4': { en: 'Click the <strong>Sift icon</strong> to manage keywords, view stats, and adjust settings', zh: '点击 <strong>Sift 图标</strong>管理关键词、查看统计和调整设置' },
  'joblens.step5': { en: 'Use inline <strong>Mute</strong> and <strong>Unfollow</strong> buttons on any post', zh: '在任意帖子上使用内联的 <strong>Mute</strong> 和 <strong>Unfollow</strong> 按钮' },
