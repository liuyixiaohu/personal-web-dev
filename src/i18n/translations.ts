...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  'joblens.feat.unfollow': { en: '<strong>One-click Unfollow</strong>: appears next to "1st" on posts and interaction headers ("XXX likes this")', zh: '<strong>一键取关</strong>：显示在帖子和互动行（「XXX 赞了此帖」）的「1st」旁边' },
  'joblens.feat.contextMenu': { en: '<strong>Mute Keyword</strong>: right-click any text on LinkedIn to instantly add it to your keyword filter', zh: '<strong>屏蔽关键词</strong>：右键 LinkedIn 上任意文字，即时加入关键词过滤' },
  ...
  'joblens.feat.polls': { en: '<strong>Hide Polls</strong>: filter out LinkedIn polls from your feed', zh: '<strong>隐藏投票</strong>：过滤动态中的 LinkedIn 投票' },
  'joblens.feat.celebrations': { en: '<strong>Hide Celebrations</strong>: hide job updates, work anniversaries, birthdays, and promotions', zh: '<strong>隐藏庆祝帖</strong>：隐藏工作变动、工作周年、生日和晋升' },
  'joblens.feat.postAge': { en: '<strong>Hide Old Posts</strong>: hide posts older than 1 day, 3 days, 1 week, 2 weeks, or 1 month', zh: '<strong>隐藏旧帖</strong>：隐藏超过 1 天、3 天、1 周、2 周或 1 个月的帖子' },
  'joblens.feat.upsells': { en: '<strong>Hide Upsells</strong>: removes "Try Campaign Manager" and similar promotions', zh: '<strong>隐藏推销</strong>：移除"试用 Campaign Manager"等推广信息' },
  'joblens.feat.pause': { en: '<strong>Shift+J</strong>: pause/resume all filters instantly', zh: '<strong>Shift+J</strong>：即时暂停/恢复所有过滤器' },
  'joblens.profileTitle': { en: 'Profile & Network', zh: '个人主页与人脉' },
  'joblens.profileDesc': {
  ...
  'joblens.feat.profileSidebar': { en: '<strong>Hide Profile Sidebar</strong>: removes ads, "People you may know", and "You might like" panels', zh: '<strong>隐藏主页侧边栏</strong>：移除广告、"你可能认识"和"你可能喜欢"面板' },
  'joblens.feat.profileAnalytics': { en: '<strong>Hide Analytics</strong>: hides profile views, impressions, and search appearances', zh: '<strong>隐藏分析</strong>：隐藏主页浏览量、曝光量和搜索出现次数' },
  'joblens.feat.networkAds': { en: '<strong>Hide Network Ads</strong>: removes Promoted ads from My Network', zh: '<strong>隐藏人脉广告</strong>：移除"我的人脉"页面的推广广告' },
  'joblens.feat.networkGame': { en: '<strong>Hide Game Promo</strong>: removes LinkedIn game promotions', zh: '<strong>隐藏游戏推广</strong>：移除 LinkedIn 游戏推广' },
