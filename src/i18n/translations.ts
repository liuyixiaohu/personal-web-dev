...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  'home.joblens.desc': { en: 'Clean up your LinkedIn feed and job search.', zh: '让你的 LinkedIn 动态和求职页面清清爽爽。' },
  ...
  'joblens.subtitle': {
    en: 'A Chrome extension that cleans up your LinkedIn feed and job search.',
    zh: '一个帮你清理 LinkedIn 动态和求职页面的 Chrome 扩展。',
  },
  ...
  'joblens.feedDesc': {
    en: 'Sift automatically hides ads, suggested posts, and recommended content from your LinkedIn feed. Mute posts by keyword to filter recurring spam topics. One-click Unfollow opens the post menu so you can unfollow directly without hunting for the ... button.',
    zh: 'Sift 自动隐藏 LinkedIn 动态中的广告、推荐帖子和建议内容。通过关键词屏蔽过滤垃圾话题。一键取消关注直接打开帖子菜单，不用再找那个 ... 按钮。',
  },
  ...
  'joblens.feat.muteKeywords': { en: '<strong>Mute Keywords</strong>: right-click any text to mute a keyword', zh: '<strong>关键词屏蔽</strong>：右键任意文字即可屏蔽关键词' },
  'joblens.feat.unfollow': { en: '<strong>One-click Unfollow</strong>: hover any post, click Unfollow to open the menu', zh: '<strong>一键取消关注</strong>：悬停帖子，点击 Unfollow 打开菜单' },
  ...
  'joblens.step4': { en: 'Click the <strong>Sift icon</strong> to open Controls, Stats, and Data tabs', zh: '点击 <strong>Sift 图标</strong>打开控制、统计和数据标签页' },
