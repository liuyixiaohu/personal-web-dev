...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  'ingrain.problem1': { en: 'You ask brilliant questions every day. You get brilliant answers. And then, reliably, you forget them. A week later you\'re asking the same thing, or worse, you don\'t even realize you\'ve already learned it once.', zh: '你每天都在问好问题，也得到了好答案。然后，毫无悬念地，你忘了。一周后你又问了同样的事，甚至更糟，你根本不记得自己已经学过一次了。' },
  'ingrain.problem2': { en: 'This isn\'t a willpower problem. It\'s how human memory works. Without reinforcement at the right intervals, knowledge decays. Psychologists have studied this for over a century. The forgetting curve is not a metaphor. It\'s a measurable, predictable phenomenon.', zh: '这不是意志力的问题，而是人类记忆的工作方式。没有在正确的时间间隔进行强化，知识就会衰减。心理学家已经研究这个现象超过一个世纪了。遗忘曲线不是比喻，它是可测量、可预测的现象。' },
  'ingrain.problem3': { en: 'InGrain exists because your AI conversations deserve better than a chat log you\'ll never scroll back to.', zh: 'InGrain 的存在，是因为你的 AI 对话值得比一段永远不会翻回去的聊天记录更好的归宿。' },
  ...
  'ingrain.notAi2': { en: 'The core of InGrain is a memory algorithm, built on decades of cognitive science research into how humans forget and retain information. The foundation draws from established work in spaced repetition theory and memory modeling, then refined and augmented by Kun to fit how people actually learn from AI conversations. It models your forgetting curve for each piece of knowledge individually, and schedules reviews at precisely the moments when you\'re about to lose something.', zh: 'InGrain 的核心是一套记忆算法，建立在数十年认知科学对人类遗忘与记忆规律的研究之上。它基于间隔重复理论和记忆建模的已有成果，再由 Kun 针对人们从 AI 对话中学习的实际方式进行改良和增强。它为每一个知识点单独建模你的遗忘曲线，并在你即将遗忘的精确时刻安排复习。' },
  'ingrain.notAi3': { en: 'No hallucinations. No probabilistic hand-waving. The algorithm tells you exactly why it\'s showing you something today and when you\'ll see it next. Every parameter is inspectable, every decision is explainable.', zh: '没有幻觉，没有概率性的含糊其辞。算法会准确地告诉你为什么今天展示这个内容，以及下次什么时候再看到它。每个参数可检查，每个决策可解释。' },
