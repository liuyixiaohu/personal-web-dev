...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  'ingrain.problem2': { en: 'This isn\'t a discipline problem. It\'s how human memory works. Without reinforcement at the right intervals, knowledge decays. Psychologists have studied this for over a century. The forgetting curve is not a metaphor. It\'s a measurable, predictable phenomenon.', zh: '这不是自律的问题，而是人类记忆的工作方式。没有在正确的时间间隔进行强化，知识就会衰减。心理学家已经研究这个现象超过一个世纪了。遗忘曲线不是比喻，它是可测量、可预测的现象。' },
  ...
  'ingrain.notAi1': { en: 'If you\'re expecting InGrain to be "AI-powered" in the way everything claims to be these days, a black box that does something vaguely smart and asks you to trust it, you\'ll be pleasantly disappointed.', zh: '如果你以为 InGrain 是那种当下流行的"AI 驱动"产品，一个做些模糊聪明的事然后让你相信它的黑箱，那你会惊喜地失望。' },
  'ingrain.notAi2': { en: 'The core of InGrain is a memory algorithm, built on decades of cognitive science research into how humans forget and retain information. The foundation draws from established work in spaced repetition theory and memory modeling, then upgraded by its creators to fit how people actually learn from AI conversations. This is not a wrapper around existing tools. It\'s a genuinely improved model. It tracks your forgetting curve for each piece of knowledge individually, and schedules reviews at precisely the moments when you\'re about to lose something.', zh: 'InGrain 的核心是一套记忆算法，建立在数十年认知科学对人类遗忘与记忆规律的研究之上。它基于间隔重复理论和记忆建模的已有成果，再由其创建者进行升级，以适应人们从 AI 对话中学习的实际方式。这不是对现有工具的包装，而是一个真正改进过的模型。它为每一个知识点单独追踪你的遗忘曲线，并在你即将遗忘的精确时刻安排复习。' },
  'ingrain.notAi3': { en: 'No hallucinations. No probabilistic hand-waving. Because every decision is grounded in an interpretable model, InGrain can provide evidence-based recommendations for what you should review, when, and why. It doesn\'t just remind you. It gives you the most effective path to actually retaining what matters.', zh: '没有幻觉，没有概率性的含糊其辞。因为每一个决策都基于可解释的模型，InGrain 能够为你提供有理有据的建议：该复习什么、什么时候复习、为什么复习。它不只是提醒你，而是为你指出真正内化知识的最有效路径。' },
  'ingrain.notAi4': { en: 'Is there AI involved? Sure, there\'s a language model that helps extract the key concepts from your conversations so you don\'t have to type them out yourself. But that\'s the assistant, not the brain. The brain is the algorithm.', zh: '有 AI 参与吗？有，一个语言模型负责从你的对话中提取关键概念，省得你自己打字。但那只是助手，不是大脑。大脑是算法。' },
  ...
  'ingrain.feat.scheduleDesc': { en: 'The memory algorithm knows when you\'re about to forget something and brings it back at exactly the right moment. Not too early, not too late.', zh: '记忆算法知道你什么时候快要忘记，并在恰到好处的时刻把它带回来。不会太早，也不会太晚。' },
  ...
  'ingrain.feat.privacy': { en: 'Your data stays yours', zh: '你的数据属于你' },
  'ingrain.feat.privacyDesc': { en: 'Everything lives on your computer. No cloud accounts, no data harvesting, no surprise subscription.', zh: '一切都在你的电脑上。没有云账户，没有数据收割，没有意外订阅。' },
  ...
  'ingrain.flowDesc': { en: 'Chat with any AI as you normally would. Click the InGrain button when you\'re done. The algorithm takes care of the rest, surfacing the right knowledge at the right time, for as long as you want to keep it.', zh: '像平常一样和任何 AI 对话。结束后点击 InGrain 按钮。算法会处理剩下的一切，在合适的时间呈现合适的知识，只要你想记住它。' },
