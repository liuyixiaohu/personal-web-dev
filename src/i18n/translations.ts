...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  'ingrain.feat.privacy': { en: 'Conversations stay on your device', zh: '对话内容留在你的设备上' },
  'ingrain.feat.privacyDesc': { en: 'Your AI conversations and knowledge content never leave your computer. Only anonymous usage patterns are synced to improve the algorithm, and only with your consent.', zh: '你的 AI 对话和知识内容不会离开你的电脑。只有匿名的使用模式数据会被同步用于改进算法，且仅在你同意的情况下。' },
