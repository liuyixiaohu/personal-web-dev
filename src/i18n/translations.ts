...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  'home.joblens.desc': { en: 'Clean up your LinkedIn feed.', zh: '让你的 LinkedIn 动态清清爽爽。' },
  ...
  'joblens.inspiration1': {
    en: 'LinkedIn is great at surfacing relevant content. But the experience? Ads everywhere, "Suggested" posts from strangers, no easy way to unfollow noisy accounts. Your feed is half noise.',
    zh: 'LinkedIn 的推荐算法确实好用，但体验呢？到处都是广告、陌生人的「推荐」帖子，想取关噪音账号还不方便。你的动态一半是噪音。',
  },
  'joblens.inspiration2': {
    en: 'Sift exists because the platform is good but the feed is broken. It gives you back a clean, focused LinkedIn experience.',
    zh: 'Sift 的存在是因为平台本身不错，但动态流不行。它让你重新拥有清爽、专注的 LinkedIn 体验。',
  },
  'joblens.changelogTitle': { en: 'Changelog', zh: '更新日志' },
  'joblens.feedTitle': { en: 'Feed Cleanup', zh: '动态清理' },
  'joblens.feedDesc': {
    en: 'Sift automatically hides ads, suggested posts, and recommended content from your LinkedIn feed. Mute and Unfollow buttons appear inline on every post. Search your keyword rules right from the popup.',
    zh: 'Sift 自动隐藏 LinkedIn 动态中的广告、推荐帖子和建议内容。Mute 和 Unfollow 按钮直接显示在每条帖子上。弹窗中可快速搜索关键词规则。',
  },
  ...
  'joblens.feat.muteKeywords': { en: '<strong>Mute Keywords</strong>: add keywords via popup or right-click menu', zh: '<strong>关键词屏蔽</strong>：通过弹窗或右键菜单添加关键词' },
  'joblens.feat.unfollow': { en: '<strong>Inline Mute & Unfollow</strong>: buttons on every post — no hunting for the ... menu', zh: '<strong>内联 Mute & Unfollow</strong>：每条帖子上直接显示按钮，不用找 ... 菜单' },
  'joblens.feat.search': { en: '<strong>Search Rules</strong>: find keywords quickly in the popup', zh: '<strong>搜索规则</strong>：在弹窗中快速查找关键词' },
  'joblens.feat.forceRecent': { en: '<strong>Force Recent</strong>: switch to chronological sort automatically', zh: '<strong>强制最新</strong>：自动切换为按时间排序' },
  ...
  'joblens.step3': { en: 'Click the <strong>Sift icon</strong> to manage keywords, view stats, and adjust settings', zh: '点击 <strong>Sift 图标</strong>管理关键词、查看统计和调整设置' },
  'joblens.step4': { en: 'Use inline <strong>Mute</strong> and <strong>Unfollow</strong> buttons on any post', zh: '在任意帖子上使用内联的 <strong>Mute</strong> 和 <strong>Unfollow</strong> 按钮' },
