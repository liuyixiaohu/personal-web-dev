...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  'pin.jiaozhou.story': {
    ...
    zh: '上世纪某一天，一个不怎么擅长英语、数学也有些烂，结果最终跑到一个说英文的国家做数据科学的我诞生了。\n就是我。\n<img src="/images/journey/jiaozhou-baby.jpg" alt="婴儿时期的坤和妈妈在胶州" class="story-photo" />\n<a href="https://baike.baidu.com/en/item/Jiaozhou%20City/997960" target="_blank" rel="noopener">胶州</a>是我真正的家乡，尽管有 5000 年的历史，但是很少有人听说过，所以有人问我是哪里人的时候，我总是说青岛的。（好在胶州确实属于青岛，所以也不全错。）',
  },
  'pin.qingdao.story': {
