...
export const translations: Record<string, Record<Lang, string>> = {
  ...
  'workflow.tue.desc': { en: 'Set 2-week plan, begin design ideation', zh: '制定两周计划，开始构思设计方案' },
  'workflow.wed.desc': { en: 'Explore design options, target ≥ 3', zh: '继续探索设计方案，目标 ≥ 3 种' },
  'workflow.thu.desc': { en: 'Refine details, prepare for Friday review', zh: '完善方案细节，准备周五汇报' },
  'workflow.fri.desc': { en: 'Review options, finalize the approach', zh: '评审方案，确定最终方案' },
  ...
  'workflow.overlapDesc': { en: 'From Tuesday to Friday of Week 2, you\'re in two cycles simultaneously:', zh: '第二周的周二到周五，你同时身处两个周期：' },
  'workflow.overlapA': { en: 'Tue–Wed: Current cycle dev + New cycle brainstorm', zh: '周二~周三：当前周期开发 + 新周期头脑风暴' },
  'workflow.overlapB': { en: 'Thu–Fri: Current cycle release/test + New cycle brainstorm/decision', zh: '周四~周五：当前周期发布测试 + 新周期头脑风暴/决策' },
  'workflow.mnemonicLabel': { en: 'Mnemonic', zh: '记忆口诀' },
  'workflow.mnemonic': { en: 'Plan-Storm-Decide-Build-Ship', zh: '二规四想，五决三开，四五发布' },
  'workflow.m1': { en: 'Tue — start planning', zh: '周二开始规划' },
  'workflow.m2': { en: '4 days brainstorm (Tue–Thu)', zh: '连续想四天（周二三四）' },
  'workflow.m3': { en: 'Fri — decide', zh: '周五做决定' },
  'workflow.m4': { en: '3 days dev (Mon–Wed)', zh: '三天开发（周一二三）' },
  'workflow.m5': { en: 'Thu–Fri — release & test', zh: '周四五发布测试' },
